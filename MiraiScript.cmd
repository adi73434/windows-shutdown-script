...
REM ----------------------------------------------------------------------------
    ...
    REM 
    REM TargetProcess: Target Process
    REM AffinityAlloc: Affinity Allocation (Temp)
    REM PowerOptions: Access Power Options.
    REM PowerPlan: Change Power Plan.
    REM ProcessKill: Kill or Restart Process.
